...
const QRCodeComponent = ({ value, size }) => {
  const encodedValue = encodeURIComponent(value || "https://appsea.ru/");
  const qrUrl = `https://api.qrserver.com/v1/create-qr-code/?size=${size}x${size}&data=${encodedValue}&margin=0`;
